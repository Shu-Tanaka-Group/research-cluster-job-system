...
| `tests/test_node_sync.py` | `watcher/node_sync.py::sync_node_resources` | 12 | ノードリソース同期。挿入 / 更新 / 削除 / 全削除 / GPU パース / API エラー時のデータ保持 / ラベルセレクタ |
...
**合計: Python 249 + Rust (cli) 62 + Rust (cjobctl) 28 = 339 テスト**
